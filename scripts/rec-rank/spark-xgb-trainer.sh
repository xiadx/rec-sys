...
echo "spark xgb trainer dep"

echo "spark xgb trainer dep normal"

# log director
job_name="SparkXGBTrainer"
...
echo "spark xgb trainer mon"

echo "spark xgb trainer mon normal"
